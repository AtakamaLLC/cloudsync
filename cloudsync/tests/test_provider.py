...
@pytest.mark.providers(["mock_path_cs", "mock_oid_ci"])  # remove this after upgrading providers to new listdir
...
@pytest.mark.providers(["mock_path_cs", "mock_oid_ci"])  # remove this after upgrading providers to support new info
